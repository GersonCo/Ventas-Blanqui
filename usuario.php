		...
		<nav class="navbar navbar-expand-md navbar-light sticky-top navbar-static-top" style="background-color: black;/*#E74C3C;*/" >
			...
			<div class="collapse navbar-collapse" id="menu">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a href="?pg=registro.php" class="nav-link" class="active" style="background-color: black; color: white;">Registro</a>
					</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<li class="nav-item">
	...
	<div class="row">
		<section class="posts col-md-12" >
			<div class="miga-de-pan">
				<ol class="breadcrumb">
					<li><h5>Los Mejores Productos Al Mejor Precio</h5></li>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="row">
				...
				<div class="col-xs-6">
					<ul class="list-inline text-rignt">
						<li><a href="https://www.facebook.com/variedadesBlanqui"><img src="image/face.png" height="40" width="40"></a></li>
